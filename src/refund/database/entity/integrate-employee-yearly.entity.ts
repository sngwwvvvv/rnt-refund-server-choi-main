...
@Entity('tb_integrate_employee_yearly')
@Unique('tb_integrate_employee_yearly_user_id_key', ['userId'])
export class IntegrateEmployeeYearlyModel extends BaseModel {
  @PrimaryGeneratedColumn('uuid', {
    name: 'id',
    primaryKeyConstraintName: 'tb_integrate_employee_yearly_pkey',
  })
  id: string
  ...
  // Second variation fields for years 1-7
  ...
  // Third variation fields for years 1-7
  ...
  @OneToOne(() => RefundUserModel, user => user.integrateEmployeeYearly, {
    onDelete: 'CASCADE',
    onUpdate: 'RESTRICT',
  })
  @JoinColumn([
    {
      ...
      foreignKeyConstraintName:
        'tb_integrate_employee_yearly_user_id_tb_refund_user_id_fk',
    },
  ])
