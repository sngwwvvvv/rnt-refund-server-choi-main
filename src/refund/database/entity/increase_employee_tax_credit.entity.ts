...
@Entity('tb_increase_employee_tax_credit')
@Unique('tb_increase_employee_tax_credit_user_id_key', ['userId'])
export class IncreaseEmployeeTaxCreditModel extends BaseModel {
  @PrimaryGeneratedColumn('uuid', {
    name: 'id',
    primaryKeyConstraintName: 'tb_increase_employee_tax_credit_pkey',
  })
  id: string
  ...
  @OneToOne(() => RefundUserModel, user => user.increaseTaxCredit, {
    onDelete: 'CASCADE',
    onUpdate: 'RESTRICT',
  })
  @JoinColumn([
    {
      ...
      foreignKeyConstraintName:
        'tb_increase_employee_tax_credit_user_id_tb_refund_user_id_fk',
    },
  ])
